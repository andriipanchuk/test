...
function undo_process_all() {
    ...
    show_mibs(false, _('Reverted all MIBs to \'uploaded\' state'));
}
...
?>
    ...
    <div id="viewAllAssociatedTrapsModal" class="modal hide" style="width: 100%;">
            ...
            <div class="modal-content" style="border-radius: 0px;">
                ...
                <div class="modal-body" style="height: 500px; overflow-y: auto; padding-right: 30px; padding-left: 30px">
                    <table class="table table-condensed table-striped table-bordered table-auto-width">
                        ...
                        //echo '<pre>' . print_r($mibs, true) . '</pre>';
    ...
    <div id="viewPartialAssociatedTrapsModal" class="modal hide" style="width: 100%;">
        <div class="modal-dialog" style=" width: 700px">
            <div class="modal-content" style="border-radius: 0px;">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h3><?php echo sprintf(_("Associated Trap Definitions - %s"), '<span class="mib-name"></span>');?></h3>
                </div>
                <div class="modal-body" style="height: 500px; overflow-y: auto; padding-right: 30px; padding-left: 30px">
                    <table class="table table-condensed table-striped table-bordered table-auto-width">
                        <thead>
