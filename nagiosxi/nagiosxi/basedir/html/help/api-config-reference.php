                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-8 col-xl-9">
                                ...
                                <pre><code id="cmd-edit-hg">curl -XPUT "<?php echo get_base_url(); ?>api/v1/config/hostgroup/testapihostgroup?apikey=<?php echo $apikey; ?>&amp;pretty=1&amp;alias=New Alias&amp;applyconfig=1"</code></pre>
                                <h6><?php echo _('Response (Success)'); ?>:</h6>
                                <pre>{
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-8 col-xl-9">
                                ...
                                <pre><code id="cmd-edit-sg">curl -XPUT "<?php echo get_base_url(); ?>api/v1/config/servicegroup/testapiservicegroup?apikey=<?php echo $apikey; ?>&amp;pretty=1&amp;alias=New Alias&amp;applyconfig=1"</code></pre>
                                <h6><?php echo _('Response (Success)'); ?>:</h6>
                                <pre>{
                    ...
                    <div class="container-fluid" style="padding: 0 5px;">
                        <div class="row">
                            ...
                            <div class="col-md-7 col-lg-8 col-xl-9">
                                ...
                                <pre><code id="cmd-add-contactgroup">curl -XPOST "<?php echo get_base_url(); ?>api/v1/config/contactgroup?apikey=<?php echo $apikey; ?>&amp;pretty=1" -d "contactgroup_name=testcontact&amp;alias=newcontactgroup&amp;applyconfig=1"</code></pre>
                                <h6><?php echo _('Response (Success)'); ?>:</h6>
                                <pre>{
    "success": "Added testcontact to the system. Config applied, Nagios Core was restarted."
}
