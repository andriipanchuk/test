...
?>
    ...
    "dbbackend": {
        "last_checkin": "2018-06-24 18:55:18",
        "bytes_processed": "207172",
        "entries_processed": "674",
        "connect_time": "2018-06-24 18:49:04",
                    ...
                    <pre>[
    {
        ...
        "result": ""
                ...
                <div class="help-section obj-reference">
                    ...
                    <p><?php echo _('Send an core command (external command and arguments) to the nagios.cmd through the API. You can send any of the commands that are listend in the').' <a target="_blank" href="https://old.nagios.org/developerinfo/externalcommands/">'._('Nagios Developer External Commands').'</a> '._('page. You will need to pass the commands completely, including semi-colons. You do not, however, need to pass the command timestamp.'); ?></p>
