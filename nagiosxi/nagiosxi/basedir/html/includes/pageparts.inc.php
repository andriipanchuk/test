...
?>
    ...
    <script type='text/javascript' src='<?php echo $base_url; ?>includes/js/jquery/jquery-3.5.1.min.js?<?php echo get_build_id(); ?>'></script>
    ...
    <?php if ($old_browser_compat) {
        ...
        <?php } else { ?>
        <script type='text/javascript' src='<?php echo $base_url; ?>includes/js/jquery/jquery-1.x.pdfgen.min.js?<?php echo get_build_id(); ?>'></script>
    <?php } } ?>
