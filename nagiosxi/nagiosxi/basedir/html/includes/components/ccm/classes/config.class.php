...
###############################################################################";
    ...
    function __construct($type) {
        ...
        $replace = array(ucfirst($type), CCMVERSION, date("Y-m-d H:i:s", mktime()));
    ...
    function createConfigSingle($strTableName, $cfgName = '', $intMode = 0, $service = '')
    {
        ...
        switch ($strTableName) {
            ...
            case "tbl_host":
                ...
                $this->getConfigData("hostbackup", $strBackupDir);
                $strSQLData = "SELECT * FROM `".$strTableName."` WHERE `host_name`='".$cfgName."' AND `config_id`=".intval($this->intDomainId);
                break;
